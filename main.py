...
pose_connections = [(mp_pose.PoseLandmark.RIGHT_EAR, mp_pose.PoseLandmark.RIGHT_SHOULDER),
...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        torso_coords = [(results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_SHOULDER].x,
        ...
        right_hip_coords = (results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_HIP].x,
                            results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_HIP].y)

        # Coordenada do ombro

        right_shoulder_coords = (results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_SHOULDER].x,
                                results.pose_landmarks.landmark[mp_pose.PoseLandmark.RIGHT_SHOULDER].y)
        ...
        trunk_slope = (right_hip_coords[1] - right_shoulder_coords[1]) / (right_hip_coords[0] - right_shoulder_coords[0])
        ...
        start_point_perpendicular = right_shoulder_coords
        ...
        trunk_angle = math.degrees(math.atan2(right_hip_coords[1] - right_shoulder_coords[1],
                                              right_hip_coords[0] - right_shoulder_coords[0]))
    ...
    #tecla enter para fechar a aplicação
